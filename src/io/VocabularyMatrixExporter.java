...
public class VocabularyMatrixExporter {

	private HashSet<Runnable> exporterThreads;

	public VocabularyMatrixExporter(){
	...
	public synchronized boolean exportMatricesToFiles(/*HashMap<String, Matrix> nameMatrixMap,*/ File outputFolder, String prefix, /*Collection<String> matrixNames,*/ int amountOfFiles){
        ...
        for(int i=0; i<Vocabulary.getSize(); i++){
            ...
            if(tw == null) continue;
			if(!tw.hasLexicalRepresentation()) continue;
		...
		for(int i=0; i<amountOfFiles; i++){
			...
			if(!targetWordSet.isEmpty()){
				...
				VocabularyMatrixExporterThread thread = new VocabularyMatrixExporterThread(this, targetWordSet, outputFile);
    ...
    */
	public synchronized void reportMatrixExporterThreadDone(VocabularyMatrixExporterThread thread){
