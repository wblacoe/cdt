/**
 * Retrieved from http://www.math.ksu.edu/~bennett/jomacg/c.html on 150602
 */
package numberTypes;
...
*/
public class NComplex extends NNumber {
    ...
    */
    public NComplex(double u,double v) {
        x=u;
        y=v;
    }
	public NComplex(double realValue){
		this(realValue, 0);
	}
	//standard value is 0
	public NComplex(){
    ...
    */
    public NComplex conj() {
        return new NComplex(x,-y);
    }
    ...
    */
    @Override
    public NComplex add(NNumber n) {
        NComplex w = (NComplex) n;
        return new NComplex(x+w.real(),y+w.imag());
    }
    ...
    /**
        ...
        @return z-w where z is this Complex number.
    */
    public NComplex subtract(NComplex w) {
        return new NComplex(x-w.real(),y-w.imag());
    }
    
    /**
        Complex multiplication (doesn't change this Complex number).
        @param n is the number to multiply by.
        @return z*w where z is this Complex number.
    */
    @Override
    public NComplex multiply(NNumber n) {
        NComplex w = (NComplex) n;
        return new NComplex(x*w.real()-y*w.imag(),x*w.imag()+y*w.real());
    }
    ...
    */
    public NComplex divide(NComplex w) {
        double den=Math.pow(w.mod(),2);
        return new NComplex((x*w.real()+y*w.imag())/den,(y*w.real()-x*w.imag())/den);
    }
    ...
    */
    public NComplex exp() {
        return new NComplex(Math.exp(x)*Math.cos(y),Math.exp(x)*Math.sin(y));
    }
    ...
    */
    public NComplex log() {
        return new NComplex(Math.log(this.mod()),this.arg());
    }
    ...
    */
    public NComplex sqrt() {
        double r=Math.sqrt(this.mod());
        double theta=this.arg()/2;
        return new NComplex(r*Math.cos(theta),r*Math.sin(theta));
    }
    ...
    */
    public NComplex sin() {
        return new NComplex(cosh(y)*Math.sin(x),sinh(y)*Math.cos(x));
    }
    ...
    */
    public NComplex cos() {
        return new NComplex(cosh(y)*Math.cos(x),-sinh(y)*Math.sin(x));
    }
    ...
    */
    public NComplex sinh() {
        return new NComplex(sinh(x)*Math.cos(y),cosh(x)*Math.sin(y));
    }
    ...
    */
    public NComplex cosh() {
        return new NComplex(cosh(x)*Math.cos(y),sinh(x)*Math.sin(y));
    }
	...
	*/
    ...
    public int compareTo(Object o){
        if(!(o instanceof NComplex)) throw new IllegalArgumentException("[NComplex] Bad comparison: Wrong type");
        NComplex n = (NComplex) o;
        return Double.compare(mod(), n.mod());
    }
