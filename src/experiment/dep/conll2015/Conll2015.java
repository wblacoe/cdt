...
public class Conll2015 extends DepExperiment {
    ...
    public static void main(String[] args){
		...
		/*File sdopsValueFolder = new File(projectFolder, "experiments/conll2015/sdops.value");
		int saveSdopsEvery = 1;
		int amountOfTreesPerThread = 1;
		exp.composeTrees(ipc, sdopsFolder, sdopsValueFolder, innerProductsFile, amountOfTreesPerThread, saveSdopsEvery);
